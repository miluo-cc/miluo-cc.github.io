...
const YoloV8SDKFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_yolov8sdk_free(ptr >>> 0, 1));

export class YoloV8SDK {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        YoloV8SDKFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_yolov8sdk_free(ptr, 0);
    }
    /**
     * @param {number} argc
     * @param {string} argv
     ...
     */
    constructor(argc, argv, _version) {
        const ptr0 = passStringToWasm0(argv, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(_version, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.yolov8sdk_new(argc, ptr0, len0, ptr1, len1);
        this.__wbg_ptr = ret >>> 0;
        YoloV8SDKFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    load_model() {
        const ret = wasm.yolov8sdk_load_model(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {boolean}
     */
    is_ready() {
        const ret = wasm.yolov8sdk_is_ready(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     * @param {number} width
     * @param {number} height
     * @param {number} image_idx
     */
    inference(image, width, height, image_idx) {
        const ptr0 = passArray8ToWasm0(image, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.yolov8sdk_inference(this.__wbg_ptr, ptr0, len0, width, height, image_idx);
    }
    /**
     * @returns {any}
     */
    get_inference_result() {
        const ret = wasm.yolov8sdk_get_inference_result(this.__wbg_ptr);
        return ret;
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper1052 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 46, __wbg_adapter_49);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper159 = function(arg0, arg1, arg2) {
        const ret = makeClosure(arg0, arg1, 23, __wbg_adapter_46);
        return ret;
    };
